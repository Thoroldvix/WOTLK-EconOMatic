package com.thoroldvix.economatic.goldprice.server;

import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.databind.DeserializationContext;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.thoroldvix.economatic.goldprice.GoldPriceDeserializer;
...
class G2GGoldPriceListDeserializerTest {
    ...
    void testDeserialize() throws IOException {
        ...
        List<GoldPricesResponse> prices = new GoldPriceDeserializer().deserialize(jp, ctxt);
