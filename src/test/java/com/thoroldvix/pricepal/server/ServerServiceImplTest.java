...
import com.thoroldvix.pricepal.server.service.ServerMapper;
...
class ServerServiceImplTest {
    ...
    void getServerById_whenValidServerId_returnsCorrectServer() {
        ...
        Server actualServer = serverServiceImpl.getServer(1);
    ...
    void getServerById_whenInvalidServerId_throwsNotFoundException() {
        ...
        assertThatThrownBy(() -> serverServiceImpl.getServer(1))
                .isInstanceOf(NotFoundException.class);
    }
    ...
    void getAllServersByName_whenValidServerName_returnsListOfServerResponse() {
        ...
        List<Server> servers = List.of(firstServerEntity, secondServerEntity);
        List<ServerResponse> expectedResponse = List.of(firstServer, secondServer);
        when(serverRepository.searchByName("ever")).thenReturn(servers);
        when(serverMapper.toServerResponse(firstServerEntity)).thenReturn(firstServer);
        when(serverMapper.toServerResponse(secondServerEntity)).thenReturn(secondServer);

        List<ServerResponse> actualResponse = serverServiceImpl.searchServerByName("ever");
    ...
    void getAllServersByName_whenServerNameEmptyOrNull_returnsListOfAllServers() {
        ...
        List<ServerResponse> actualResponse = serverServiceImpl.searchServerByName("");
    ...
    void getServerResponseById_whenValidServerId_returnsCorrectServer() {
        ...
        ServerResponse actualServer = serverServiceImpl.getServerResponse(1);
    ...
    void getServerResponseById_whenInvalidServerId_throwsNotFoundException() {
        ...
        assertThatThrownBy(() -> serverServiceImpl.getServerResponse(1))
                .isInstanceOf(NotFoundException.class);
    }
}