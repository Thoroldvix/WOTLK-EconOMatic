...
public class StatisticsRepositoryImpl<E> implements StatisticsRepository<E>{
    ...
    @Override
    public Map<String, Object> getStats(Specification<E> spec,
                                        Class<E> entityClass) {
        ...
        } else if (GoldPrice.class.equals(entityClass)) {
            return getStatisticsForEntity((Specification<GoldPrice>) spec, GoldPrice.class, "price", BigDecimal.class);
        }
